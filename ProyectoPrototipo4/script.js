...
window.onload = function() {
    ...
    // --- VERIFICAR SESIÓN ---
    fetch('verificar_sesion.php').then(response => {
...
function processPayment() {
    ...
    setTimeout(async () => { // Agregamos async aquí
        ...
        setTimeout(async () => {
            ...
            try {
                // Ejecutamos la generación del PDF
                await generateTicket(); 
                
                // Solo vaciamos el carrito si el PDF se generó con éxito
                cart = []; 
                renderCart();
            } catch (error) {
...
async function generateTicket() {
    ...
    try {
        ...
        const response = await fetch('factura.php'); 
